...
#include "Enregistrement.h"
	...
	class BDD
	{
		...
		public: vector<Enregistrement*> obtenirListeDesLampadairesProches(double latitude,double longitude);
		...
		public: void modifierEnregistrement(int id,int puissance, string albedo, string fluxLum, string idRaspbery, string typeAmpoule, string typeLampadaire, string hauteur, double latitude, double longitude, int nbImages, string agglo, string rue, int ulor, string date,string notes);
