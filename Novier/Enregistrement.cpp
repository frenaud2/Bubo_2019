...
Enregistrement::Enregistrement(int aId, string aAlbedo, string aFluxLum, string aIdRaspberry, string aTypeAmpoule, string aTypeLampadaire, string aHauteur, double aLatitude, double aLongitude, int aNbImages, string aAgglo, string aRue, int aUlor, string aDate, string aNotes, int puissance){
...
Enregistrement::Enregistrement( string aAlbedo, string aFluxLum, string aIdRaspberry, string aTypeAmpoule, string aTypeLampadaire, string aHauteur, double aLatitude, double aLongitude, int aNbImages, string aAgglo, string aRue, int aUlor, string aDate, string aNotes, int aPuissance){
  	 horodatage = new Horodatage();
        geolocalisation = new Geolocalisation();
        ampoule = new Ampoule();
        _identifiant="";
...
int Enregistrement::localiserSF() {
	...
	erreur = geolocalisation->localiserSF(aLatitude_,aLongitude);
	if (erreur>0) horodatage->dater();
	return erreur;
}
